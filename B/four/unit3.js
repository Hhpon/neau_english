...
function getSuccessPage(cookie) {
  return new Promise(function (resolve, rejsct) {
    request({
      url: 'http://202.118.163.67/book/book144/unit_index.php?UnitID=3',
      headers: {
  ...
  return new Promise(function (resolve, reject) {
    request({
      ...
      form: {
        ...
        'Blank_0_1': 'free',
        'Blank_0_2': 'music',
        'Blank_0_3': 'internationally',
        'Blank_0_4': 'festivals',
        'Blank_0_5': 'spend your free time',
      }
    }, (err, res, html) => {
      $ = cheerio.load(html);
  ...
  return new Promise(function (resolve, reject) {
    request({
      ...
      form: {
        ...
        KidID: 1,
        ItemID: 28,
        'Blank_0_0': 'husky sledding',
        'Blank_0_1': '38',
        'Blank_1_0': 'wing-walking',
        'Blank_1_1': '35',
        'Blank_2_0': 'driving on Route 66',
        'Blank_2_1': '19',
        'Blank_3_0': 'bungee jumping',
        'Blank_3_1': '17',
        'Blank_4_0': 'swimming with dolphins',
        'Blank_4_1': '1',
      }
    }, (err, res, html) => {
      $ = cheerio.load(html);
  ...
  return new Promise(function (resolve, reject) {
    request({
      ...
      form: {
        ...
        'Blank_0_0': 'resorts',
        'Blank_0_1': 'sprung up',
        'Blank_0_2': 'dramatically',
        'Blank_0_3': 'having an adverse effect on',
        'Blank_0_4': 'combat',
        'Blank_0_5': 'wilderness',
        'Blank_0_6': 'unspoiled',
        'Blank_0_7': 'streams of',
        'Blank_0_8': 'guidelines',
        'Blank_0_9': 'auction off',
      }
    }, (err, res, html) => {
      $ = cheerio.load(html);
      var res = $('.dwt>p').text().trim();
  ...
  return new Promise(function (resolve, reject) {
    request({
      ...
      form: {
        ...
        'MC_129_3': 'c',
        'MC_129_4': 'd',
        'Blank_137_0_0': 'audience',
        'Blank_137_0_1': 'teenage',
        'Blank_137_0_2': 'celebrate',
        'Blank_137_0_3': 'Popular',
        'Blank_137_0_4': 'conquers',
        'Blank_137_0_5': 'columns',
        'Blank_137_0_6': 'is central to',
        'Blank_137_0_7': 'a private arrangement',
        'Blank_137_0_8': 'to choose',
        'Blank_137_0_9': 'apart from',
      }
    }, (err, res, html) => {
      $ = cheerio.load(html);
      var res = $('.dwt>p').text().trim();
