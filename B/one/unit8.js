...
function getSuccessPage(cookie) {
  return new Promise(function (resolve, rejsct) {
    request({
      url: 'http://202.118.163.67/book/book141/unit_index.php?UnitID=8',
      headers: {
  ...
  return new Promise(function (resolve, reject) {
    request({
      ...
      form: {
        ...
        'Blank_0_1': 'rubber',
        'Blank_0_2': '1891',
        'Blank_0_3': 'concentrate',
        'Blank_0_4': 'the mobile phone',
        'Blank_0_5': '1973',
        'Blank_0_6': 'countries',
        'Blank_0_7': 'light',
        'Blank_0_8': '2001',
  ...
  return new Promise(function (resolve, reject) {
    request({
      ...
      form: {
        ...
        'Blank_0_0': 'early 30s',
        'Blank_0_1': '6 billion',
        'Blank_1_0': 'computer science students',
        'Blank_2_0': 'tour guide',
        'Blank_2_1': 'in the group',
        'Blank_3_0': 'searching the Internet',
        'Blank_4_0': '2000',
        'Blank_4_1': 'successful business',
        'Blank_5_0': 'fastest growing',
        'Blank_5_1': 'most profitable'
      }
    }, (err, res, html) => {
      $ = cheerio.load(html);
      var res = $('.dwt>p').text().trim();
  ...
  return new Promise(function (resolve, reject) {
    request({
      ...
      form: {
        ...
        KidID: 1,
        ItemID: 513,
        'Blank_0_0': 'footballers',
        'Blank_1_0': 'fire fighters',
        'Blank_2_0': 'doctors',
        'Blank_3_0': 'teachers'
      }
    }, (err, res, html) => {
  ...
  return new Promise(function (resolve, reject) {
    request({
      ...
      form: {
        ...
        'Blank_0_0': 'evidence',
        'Blank_0_1': 'enhance',
        'Blank_0_2': 'interviewed',
        'Blank_0_3': 'rated',
        'Blank_0_4': 'took into account',
        'Blank_0_5': 'forecast',
        'Blank_0_6': 'emerged',
        'Blank_0_7': 'was related to',
        'Blank_0_8': 'adapt themselves to',
        'Blank_0_9': 'original'
      }
    }, (err, res, html) => {
      $ = cheerio.load(html);
  ...
  return new Promise(function (resolve, reject) {
    request({
      ...
      form: {
        ...
        'MC_163_3': 'a',
        'MC_163_4': 'c',
        'Blank_170_0_0': 'accessible',
        'Blank_170_0_1': 'opens a checking account',
        'Blank_170_0_2': 'regularly',
        'Blank_170_0_3': 'orders',
        'Blank_170_0_4': 'exchange',
        'Blank_170_0_5': 'bank account',
        'Blank_170_0_6': 'return',
        'Blank_170_0_7': 'interest',
        'Blank_170_0_8': 'instead of',
        'Blank_170_0_9': 'valuable'
      }
    }, (err, res, html) => {
      $ = cheerio.load(html);
      var res = $('.dwt>p').text().trim();
