...
function getSuccessPage(cookie) {
  return new Promise(function (resolve, rejsct) {
    request({
      url: 'http://202.118.163.67/book/book143/unit_index.php?UnitID=5',
      headers: {
  ...
  return new Promise(function (resolve, reject) {
    request({
      ...
      form: {
        ...
        'Blank_0_0': 'producer',
        'Blank_0_1': 'enjoys',
        'Blank_0_2': 'in a successful band',
        'Blank_0_3': 'dream jobs'
      }
    }, (err, res, html) => {
      $ = cheerio.load(html);
  ...
  return new Promise(function (resolve, reject) {
    request({
      ...
      form: {
        ...
        KidID: 1,
        ItemID: 117,
        'Blank_0_0': 'footballer',
        'Blank_0_1': 'enough',
        'Blank_1_0': 'professional',
        'Blank_1_1': 'performing',
        'Blank_2_0': 'band',
        'Blank_2_1': 'world-famous',
        'Blank_3_0': 'sports',
        'Blank_3_1': 'later on',
        'Blank_3_2': 'serving people'
      }
    }, (err, res, html) => {
      $ = cheerio.load(html);
      var res = $('.dwt>p').text().trim();
  ...
  return new Promise(function (resolve, reject) {
    request({
      ...
      form: {
        ...
        KidID: 1,
        ItemID: 325,
        'Blank_0_0': 'loved fashion',
        'Blank_0_1': 'amazing for me',
        'Blank_0_2': 'hard work',
        'Blank_1_0': 'look good all the time',
        'Blank_1_1': 'feeling terrible',
        'Blank_2_0': 'eating delicious food',
        'Blank_2_1': 'get paid',
        'Blank_2_2': 'get bored',
        'Blank_3_0': 'work off',
        'Blank_3_1': 'I gave it up',
        'Blank_4_0': 'wonderfully romantic',
        'Blank_4_1': 'how tiring',
        'Blank_5_0': 'ruin the grapes',
        'Blank_5_1': 'worry about the weather',
        'Blank_5_2': 'absolutely fascinating'
      }
    }, (err, res, html) => {
      $ = cheerio.load(html);
      var res = $('.dwt>p').text().trim();
  ...
  return new Promise(function (resolve, reject) {
    request({
      ...
      form: {
        ...
        KidID: 1,
        ItemID: 198,
        'Blank_0_0': 'suffer from',
        'Blank_0_1': 'enthusiastic',
        'Blank_0_2': 'erodes',
        'Blank_0_3': 'competent',
        'Blank_0_4': 'clear-cut',
        'Blank_0_5': 'labeling',
        'Blank_0_6': 'comes down to',
        'Blank_0_7': 'commonplace',
        'Blank_0_8': 'tend to',
        'Blank_0_9': 'focusing on'
      }
    }, (err, res, html) => {
      $ = cheerio.load(html);
      var res = $('.dwt>p').text().trim();
  ...
  return new Promise(function (resolve, reject) {
    request({
      ...
      form: {
        ...
        'MC_221_3': 'a',
        'MC_221_4': 'd',
        'Blank_230_0_0': 'predict',
        'Blank_230_0_1': 'identical',
        'Blank_230_0_2': 'typical',
        'Blank_230_0_3': 'boring',
        'Blank_230_0_4': 'variety',
        'Blank_230_0_5': 'dangerous',
        'Blank_230_0_6': 'normal',
        'Blank_230_0_7': 'some robbers',
        'Blank_230_0_8': 'captured',
        'Blank_230_0_9': 'right there'
      }
    }, (err, res, html) => {
      $ = cheerio.load(html);
      var res = $('.dwt>p').text().trim();
