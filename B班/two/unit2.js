...
function getSuccessPage(cookie) {
  return new Promise(function (resolve, rejsct) {
    request({
      url: 'http://202.118.163.67/book/book142/unit_index.php?UnitID=2',
      headers: {
  ...
  return new Promise(function (resolve, reject) {
    request({
      ...
      form: {
        ...
        KidID: 1,
        ItemID: 166,
        'Blank_0_0': 'slowly sinking ',
        'Blank_1_0': 'two and a half ',
        'Blank_2_0': 'try and stop',
        'Blank_3_0': 'temporary ',
        'Blank_4_0': 'permanent',
      }
    }, (err, res, html) => {
  ...
  return new Promise(function (resolve, reject) {
    request({
      ...
      form: {
        ...
        'Blank_0_0': 'trying to',
        'Blank_0_1': 'takes ',
        'Blank_0_2': ' looking for',
        'Blank_0_3': 'right way ',
        'Blank_0_4': ' the first left ',
        'Blank_0_5': 'until you reach',
        'Blank_0_6': ' get to',
        'Blank_0_7': 'Is it far',
        'Blank_0_8': 'Go left ',
        'Blank_0_9': 'on the left',
      }
    }, (err, res, html) => {
      $ = cheerio.load(html);
      var res = $('.dwt>p').text().trim();
  ...
  return new Promise(function (resolve, reject) {
    request({
      ...
      form: {
        ...
        'Blank_0_1': 'far ',
        'Blank_0_2': 'plane ',
        'Blank_0_3': ' three months',
        'Blank_0_4': 'culture ',
        'Blank_0_5': 'way of life',
        'Blank_0_6': ' speak to ',
        'Blank_0_7': 'find out',
        'Blank_0_8': 'history ',
        'Blank_0_9': 'dreams ',
  ...
  return new Promise(function (resolve, reject) {
    request({
      ...
      form: {
        ...
        'Blank_0_2': 'negative ',
        'Blank_0_3': 'result in',
        'Blank_0_4': 'lose faith in',
        'Blank_0_5': 'goes down',
        'Blank_0_6': 'depressed ',
        'Blank_0_7': 'preferably ',
        'Blank_0_8': 'adapt ',
        'Blank_0_9': 'reveal ',
      }
    }, (err, res, html) => {
  ...
  return new Promise(function (resolve, reject) {
    request({
      ...
      form: {
        ...
        'MC_341_2': 'd',
        'MC_341_3': 'b',
        'Blank_349_0_0': 'vacation ',
        'Blank_349_0_1': 'walks of life',
        'Blank_349_0_2': 'routine ',
        'Blank_349_0_3': 'adventure ',
        'Blank_349_0_4': 'treat ',
        'Blank_349_0_5': 'popularity ',
        'Blank_349_0_6': 'gain a better understanding of ',
        'Blank_349_0_7': 'similarities ',
        'Blank_349_0_8': 'perspective ',
        'Blank_349_0_9': 'marvelous ',
      }
    }, (err, res, html) => {
      $ = cheerio.load(html);
      var res = $('.dwt>p').text().trim();
